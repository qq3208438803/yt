...
enum
{
...
#ifdef OFFLINE_SHOP
	HEADER_GD_SHOP_NAME = 147,
	HEADER_GD_SHOP_CLOSE = 148,
	HEADER_GD_SHOP_UPDATE_ITEM = 149,
#endif	
	...
	HEADER_GD_GUILD_DUNGEON = 143,
	HEADER_GD_GUILD_DUNGEON_CD = 144,
	...
	#ifdef OFFLINE_SHOP
	HEADER_DG_SHOP_NAME = 147,
	HEADER_DG_SHOP_CLOSE = 148,
	HEADER_DG_SHOP_UPDATE_ITEM = 149,	
#endif
	...
	HEADER_DG_GUILD_DUNGEON_ST = 184, //Fix BUG MELEY DANYEL
...
#ifdef ENABLE_EXTEND_INVEN_SYSTEM1
	DWORD	extend_inven;
#endif	
...
typedef struct SShopItemTable
{
	...
	#ifdef FULL_YANG
	long long		price;	// PC, shop_table_ex.txt ?ŦÐ…?…?? ?��??
	#else
	DWORD		price;	// PC, shop_table_ex.txt ?ŦÐ…?…?? ?��??
	#endif	
