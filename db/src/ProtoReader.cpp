...
int get_Item_SubType_Value(unsigned int type_value, string inputString)
{
	...
	static string arSub3[] = { "USE_POTION", "USE_TALISMAN", "USE_TUNING", "USE_MOVE", "USE_TREASURE_BOX", "USE_MONEYBAG", "USE_BAIT",
				...
				"USE_CHANGE_COSTUME_ATTR", "USE_RESET_COSTUME_ATTR", "USE_UNK33", "USE_CHANGE_ATTRIBUTE_PLUS", "USE_MOUNT"};
	...
	static string arSub28[] = { "COSTUME_BODY", "COSTUME_HAIR", "COSTUME_MOUNT", "COSTUME_SASH", "COSTUME_WEAPON" };
...
int get_Item_WearFlag_Value(string inputString)
{
	...
	string arWearrFlag[] = {"WEAR_BODY", "WEAR_HEAD", "WEAR_FOOTS", "WEAR_WRIST", "WEAR_WEAPON", "WEAR_NECK", "WEAR_EAR", "WEAR_SHIELD", "WEAR_UNIQUE",
					"WEAR_ARROW", "WEAR_HAIR", "WEAR_ABILITY", "WEAR_COSTUME_BODY", "WEAR_COSTUME_HAIR", "WEAR_COSTUME_MOUNT", "WEAR_COSTUME_SASH", "WEAR_COSTUME_WEAPON"
#ifdef ENABLE_PENDANT
					, "WEAR_PENDANT"  
#endif
					};
...
int get_Item_ApplyType_Value(string inputString)
{
	string arApplyType[] = {"APPLY_NONE", "APPLY_MAX_HP", "APPLY_MAX_SP", "APPLY_CON", "APPLY_INT", "APPLY_STR", "APPLY_DEX", "APPLY_ATT_SPEED",
			...
			, "APPLY_ENCHANT_ELECT", "APPLY_ENCHANT_FIRE", "APPLY_ENCHANT_ICE", "APPLY_ENCHANT_WIND", "APPLY_ENCHANT_EARTH", "APPLY_ENCHANT_DARK",
			"APPLY_ATTBONUS_INSECT", "APPLY_ATTBONUS_DESERT", "APPLY_ATTBONUS_CZ"
#endif
#ifdef ENABLE_PENDANT
			, "APPLY_ATTBONUS_SWORD", "APPLY_ATTBONUS_TWOHAND", "APPLY_ATTBONUS_DAGGER", "APPLY_ATTBONUS_BELL", "APPLY_ATTBONUS_FAN", "APPLY_ATTBONUS_BOW"
#ifdef ENABLE_WOLFMAN_CHARACTER
			, "APPLY_ATTBONUS_CLAW"
#endif
			, "APPLY_RESIST_HUMAN", "APPLY_RESIST_MOUNT_FALL"
#endif			
	};
